...
c>>0,0!==this._cycle&&this._cycle===this._totalTime/c&&this._cycle--,this._time=this._totalTime-this._cycle*c,this._yoyo&&0!=(this._cycle&1)&&(this._time=this._duration-this._time),this._time>this._duration?(this._time=this._duration,c=this._duration+1E-6):0>this._time?(this._time=0,c=-1E-6):c=this._time));if(this._cycle!==x&&!this._locked){var n=this._yoyo&&0!==(x&1),P=n===(this._yoyo&&0!==(this._cycle&1)),w=this._totalTime,y=this._cycle,F=this._rawPrevTime,C=this._time;this._totalTime=x*this._duration;
this._cycle<x?n=!n:this._totalTime+=this._duration;this._time=d;this._rawPrevTime=i;this._cycle=x;this._locked=!0;d=n?0:this._duration;this.render(d,e,!1);e||this._gc||this.vars.onRepeat&&this.vars.onRepeat.apply(this.vars.onRepeatScope||this,this.vars.onRepeatParams||s);P&&(d=n?this._duration+1E-6:-1E-6,this.render(d,!0,!1));this._time=C;this._totalTime=w;this._cycle=y;this._rawPrevTime=F;this._locked=!1}if(this._time!==d||b){this._initted||(this._initted=!0);0===f&&this.vars.onStart&&0!==this._totalTime&&
...
k,A,h,i,x){var m={},B=[],n,q,i="string"===typeof i?","+i+",":",x,y,z,left,top,right,bottom,marginTop,marginLeft,marginRight,marginBottom,paddingLeft,paddingTop,paddingRight,paddingBottom,backgroundPosition,backgroundPosition_y,";null==k&&(k=1);for(q in f[0])B.push(q);s.length=c.length=t.length=0;for(n=B.length;-1<--n;){q=B[n];e[q]=-1!==i.indexOf(","+q+",");var w=m,y=q,F;F=f;var C=q,p=e[q],D=x,H=[],G=void 0,z=void 0,E=void 0,g=void 0,u=void 0,G=void 0;if(D){F=[D].concat(F);for(z=F.length;-1<--z;)if("string"===
typeof(G=F[z][C]))"="===G.charAt(1)&&(F[z][C]=D[C]+Number(G.charAt(0)+G.substr(2)))}G=F.length-2;if(0>G)H[0]=new b(F[0][C],0,0,F[-1>G?0:1][C]);else{for(z=0;z<G;z++)E=F[z][C],g=F[z+1][C],H[z]=new b(E,0,0,g),p&&(u=F[z+2][C],s[z]=(s[z]||0)+(g-E)*(g-E),c[z]=(c[z]||0)+(u-g)*(u-g));H[z]=new b(F[z][C],0,0,F[z+1][C])}F=H;w[y]=F}for(n=s.length;-1<--n;)s[n]=Math.sqrt(s[n]),c[n]=Math.sqrt(c[n]);if(!h){for(n=B.length;-1<--n;)if(e[q]){a=m[B[n]];l=a.length-1;for(j=0;j<l;j++)r=a[j+1].da/c[j]+a[j].da/s[j],t[j]=(t[j]||
0)+r*r}for(n=t.length;-1<--n;)t[n]=Math.sqrt(t[n])}for(n=B.length;-1<--n;){q=B[n];f=m[q];i=k;x=A;w=h;q=e[q];y=f.length-1;F=0;for(var C=f[0].a,v=u=g=D=G=g=E=G=z=E=H=D=p=void 0,p=0;p<y;p++)z=f[F],D=z.a,H=z.d,E=f[F+1].d,q?(g=s[p],u=c[p],v=0.25*(u+g)*i/(w?0.5:t[p]||0.5),G=H-(H-D)*(w?0.5*i:v/g),E=H+(E-H)*(w?0.5*i:v/u),g=H-(G+(E-G)*(3*g/(g+u)+0.5)/4)):(G=H-0.5*(H-D)*i,E=H+0.5*(E-H)*i,g=H-(G+E)/2),G+=g,E+=g,z.c=G,z.b=0!=p?C:C=z.a+0.6*(z.c-z.a),z.da=H-D,z.ca=G-D,z.ba=C-D,x?(D=d(D,C,G,H),f.splice(F,1,D[0],
D[1],D[2],D[3]),F+=4):F++,C=E;z=f[F];z.b=C;z.c=C+0.4*(z.d-C);z.da=z.d-z.a;z.ca=z.c-z.a;z.ba=C-z.a;x&&(D=d(z.a,C,z.c,z.d),f.splice(F,1,D[0],D[1],D[2],D[3]))}return m},d=w.cubicToQuadratic=function(b,c,d,e){var i={a:b},x={},h={},q={c:e},n=(b+c)/2,s=(c+d)/2,d=(d+e)/2,c=(n+s)/2,s=(s+d)/2,t=(s-c)/8;i.b=n+(b-n)/4;x.b=c+t;i.c=x.a=(i.b+x.b)/2;x.c=h.a=(c+s)/2;h.b=s-t;q.b=d+(e-d)/4;h.c=q.a=(h.b+q.b)/2;return[i,x,h,q]};w.quadraticToCubic=function(c,d,e){return new b(c,(2*d+c)/3,(2*d+e)/3,e)};i.constructor=w;
w.API=2;i._onInitTween=function(c,d,e){this._target=c;d instanceof Array&&(d={values:d});this._props=[];this._timeRes=null==d.timeResolution?6:parseInt(d.timeResolution);var i=d.values||[],q={},x=i[0],e=d.autoRotate||e.vars.orientToBezier,m,B,n;this._autoRotate=e?e instanceof Array?e:[["x","y","rotation",!0===e?0:Number(e)||0]]:null;for(m in x)this._props.push(m);for(x=this._props.length;-1<--x;)m=this._props[x],this._overwriteProps.push(m),e=this._func[m]="function"===typeof c[m],q[m]=!e?parseFloat(c[m]):
c[m.indexOf("set")||"function"!==typeof c["get"+m.substr(3)]?m:"get"+m.substr(3)](),n||q[m]!==i[0][m]&&(n=q);if("cubic"!==d.type&&"quadratic"!==d.type&&"soft"!==d.type)q=h(i,isNaN(d.curviness)?1:d.curviness,!1,"thruBasic"===d.type,d.correlate,n);else{e=(e=d.type)||"soft";d={};n="cubic"===e?3:2;var e="soft"===e,x=[],s,t,w,y,C,p,D,H,G;e&&q&&(i=[q].concat(i));if(null==i||i.length<n+1)throw"invalid Bezier data";for(t in i[0])x.push(t);for(p=x.length;-1<--p;){t=x[p];d[t]=C=[];G=0;H=i.length;for(D=0;D<
H;D++)s=null==q?i[D][t]:"string"===typeof(w=i[D][t])&&"="===w.charAt(1)?q[t]+Number(w.charAt(0)+w.substr(2)):Number(w),e&&1<D&&D<H-1&&(C[G++]=(s+C[G-2])/2),C[G++]=s;H=G-n+1;for(D=G=0;D<H;D+=n)s=C[D],t=C[D+1],w=C[D+2],y=2===n?0:C[D+3],C[G++]=w=3===n?new b(s,t,w,y):new b(s,(2*t+s)/3,(2*t+w)/3,w);C.length=G}q=d}this._beziers=q;this._segCount=this._beziers[m].length;if(this._timeRes){x=this._beziers;m=this._timeRes;m=m>>0||6;q=[];t=[];i=w=0;d=m-1;n=[];e=[];for(B in x){s=x[B];C=q;p=m;D=1/p;H=s.length;
for(var z=void 0,E=void 0,g=y=G=E=void 0,u=z=void 0,v=void 0,v=g=void 0;-1<--H;){g=s[H];E=g.a;G=g.d-E;y=g.c-E;g=g.b-E;E=0;for(u=1;u<=p;u++)z=D*u,v=1-z,z=E-(E=(z*z*G+3*v*(z*y+v*g))*z),v=H*p+u-1,C[v]=(C[v]||0)+z*z}}x=q.length;for(B=0;B<x;B++)w+=Math.sqrt(q[B]),s=B%m,e[s]=w,s===d&&(i+=w,s=B/m>>0,n[s]=e,t[s]=i,w=0,e=[]);this._length=i;this._lengths=t;this._segments=n;this._l1=this._li=this._s1=this._si=0;this._l2=this._lengths[0];this._curSeg=this._segments[0];this._s2=this._curSeg[0];this._prec=1/this._curSeg.length}if(e=
this._autoRotate){e[0]instanceof Array||(this._autoRotate=e=[e]);for(x=e.length;-1<--x;)for(B=0;3>B;B++)m=e[x][B],this._func[m]="function"===typeof c[m]?c[m.indexOf("set")||"function"!==typeof c["get"+m.substr(3)]?m:"get"+m.substr(3)]:!1}return!0};i.setRatio=function(b){var d=this._segCount,c=this._func,e=this._target,i,h,m,s,n;if(this._timeRes){i=this._lengths;s=this._curSeg;b*=this._length;h=this._li;if(b>this._l2&&h<d-1){for(d-=1;h<d&&(this._l2=i[++h])<=b;);this._l1=i[h-1];this._li=h;this._curSeg=
...
h}s=(h+(b-this._s1)/(this._s2-this._s1))*this._prec}else i=0>b?0:1<=b?d-1:d*b>>0,s=(b-i*(1/d))*d;d=1-s;for(h=this._props.length;-1<--h;)if(b=this._props[h],m=this._beziers[b][i],n=(s*s*m.da+3*d*(s*m.ca+d*m.ba))*s+m.a,this._round[b]&&(n=n+(0<n?0.5:-0.5)>>0),c[b])e[b](n);else e[b]=n;if(this._autoRotate){var d=this._autoRotate,t,w,y,F,C;for(h=d.length;-1<--h;)b=d[h][2],F=d[h][3]||0,C=!0==d[h][4]?1:q,m=this._beziers[d[h][0]][i],n=this._beziers[d[h][1]][i],t=m.a+(m.b-m.a)*s,w=m.b+(m.c-m.b)*s,t+=(w-t)*
s,w+=(m.c+(m.d-m.c)*s-w)*s,m=n.a+(n.b-n.a)*s,y=n.b+(n.c-n.b)*s,m+=(y-m)*s,y+=(n.c+(n.d-n.c)*s-y)*s,n=Math.atan2(y-m,w-t)*C+F,c[b]?c[b].call(e,n):e[b]=n}};i._roundProps=function(b,d){for(var c=this._overwriteProps,e=c.length;-1<--e;)if(b[c[e]]||b.bezier||b.bezierThrough)this._round[c[e]]=d};i._kill=function(b){var d=this._props,c,e;for(c in _beziers)if(c in b){delete this._beziers[c];delete this._func[c];for(e=d.length;-1<--e;)d[e]===c&&d.splice(e,1)}return y.prototype._kill.call(this,b)};y.activate([w]);
...
k=/(M11|M12|M21|M22)=[\d\-\.e]+/gi,A=/progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i,L=Math.PI/180,O=180/Math.PI,x={},m=document,B=m.createElement("div"),n=navigator.userAgent,P,M,N,F,C,p=n.indexOf("Android"),D=m.createElement("div");N=-1!==n.indexOf("Safari")&&-1===n.indexOf("Chrome")&&(-1===p||3<Number(n.substr(p+8,1)));/MSIE ([0-9]{1,}[\.0-9]{0,})/.exec(n);F=parseFloat(RegExp.$1);D.innerHTML="<a style='top:1px;opacity:.55;'>a</a>";C=(n=D.getElementsByTagName("a")[0])?/^0.55/.test(n.style.opacity):
...
E=function(g,d,c,v){return!C&&"opacity"===d?G(g):!v&&g.style[d]?g.style[d]:(c=c||z(g,null))?(g=c.getPropertyValue(d.replace(b,"-$1").toLowerCase()))||c.length?g:c[d]:g.currentStyle?(c=g.currentStyle,v=c[d],!v&&"backgroundPosition"===d?c[d+"X"]+" "+c[d+"Y"]:v):null},g=function(b,g){var c={},v;if(g=g||z(b,null))if(v=g.length)for(;-1<--v;)c[g[v].replace(h,d)]=g.getPropertyValue(g[v]);else for(v in g)c[v]=g[v];else if(g=b.currentStyle||b.style)for(v in g)c[v.replace(h,d)]=g[v];C||(c.opacity=G(b));v=S(b,
g,!1);c.rotation=v.rotation*O;c.skewX=v.skewX*O;c.scaleX=v.scaleX;c.scaleY=v.scaleY;c.x=v.x;c.y=v.y;null!=c.filters&&delete c.filters;return c},u=function(b,g,d,c){var v={},u,p;for(p in g)if("cssText"!==p&&"length"!==p&&isNaN(p)&&b[p]!=(u=g[p]))if(u!==J&&("number"===typeof u||"string"===typeof u))v[p]=(""===u||"auto"===u)&&"string"===typeof b[p]&&""!==b[p].replace(q,"")?0:u,c&&c.props.push(p);if(d)for(p in d)"className"!==p&&(v[p]=d[p]);return v},v={scaleX:1,scaleY:1,x:1,y:1,rotation:1,shortRotation:1,
skewX:1,skewY:1,scale:1},I="",K="",J=function(b,g){var g=g||m.body||m.documentElement,d=z(g,""),c,v;if(E(g,b))return b;b=b.substr(0,1).toUpperCase()+b.substr(1);c=["O","Moz","ms","Ms","Webkit"];for(v=5;-1<--v&&!E(g,c[v]+b,d););return 0<=v?(K=3===v?"ms":c[v],I="-"+K.toLowerCase()+"-",K+b):null}("transform"),W=I+"transform",S=function(b,g,d){var c=b._gsTransform,v;J?v=E(b,W,g,!0):b.currentStyle&&(v=(v=b.currentStyle.filter.match(k))&&4===v.length?v[0].substr(4)+","+Number(v[2].substr(4))+","+Number(v[1].substr(4))+
","+v[3].substr(4)+","+(c?c.x:0)+","+(c?c.y:0):null);var g=(v||"").replace(/[^\d\-\.e,]/g,"").split(","),u=(v=6<=g.length)?Number(g[0]):1,p=v?Number(g[1]):0,f=v?Number(g[2]):0,e=v?Number(g[3]):1,c=d?c||{skewY:0}:{skewY:0},h=0>c.scaleX;c.x=v?Number(g[4]):0;c.y=v?Number(g[5]):0;c.scaleX=Math.sqrt(u*u+p*p);c.scaleY=Math.sqrt(e*e+f*f);c.rotation=u||p?Math.atan2(p,u):c.rotation||0;c.skewX=f||e?Math.atan2(f,e)+c.rotation:c.skewX||0;Math.abs(c.skewX)>Math.PI/2&&(h?(c.scaleX*=-1,c.skewX+=0>=c.rotation?Math.PI:
-Math.PI,c.rotation+=0>=c.rotation?Math.PI:-Math.PI):(c.scaleY*=-1,c.skewX+=0>=c.skewX?Math.PI:-Math.PI));if(1E-6>c.rotation&&-1E-6<c.rotation&&(u||p))c.rotation=0;if(1E-6>c.skewX&&-1E-6<c.skewX&&(p||f))c.skewX=0;d&&(b._gsTransform=c);return c},X={width:["Left","Right"],height:["Top","Bottom"]},Y=["marginLeft","marginRight","marginTop","marginBottom"],Q=function(b,g,c,d,v){if("px"===d||!d)return c;if("auto"===d||!c)return 0;var u=f.test(g),p=b,e=B.style,h=0>c;h&&(c=-c);e.cssText="border-style:solid; border-width:0; position:absolute; line-height:0;";
"%"===d||"em"===d||!p.appendChild?(p=b.parentNode||m.body,e[u?"width":"height"]=c+d):e[u?"borderLeftWidth":"borderTopWidth"]=c+d;p.appendChild(B);u=parseFloat(B[u?"offsetWidth":"offsetHeight"]);p.removeChild(B);0===u&&!v&&(u=Q(b,g,c,d,!0));return h?-u:u},V=function(b,g){if(null==b||""===b||"auto"===b||"auto auto"===b)b="0 0";var g=g||{},c=-1!==b.indexOf("left")?"0%":-1!==b.indexOf("right")?"100%":b.split(" ")[0],d=-1!==b.indexOf("top")?"0%":-1!==b.indexOf("bottom")?"100%":b.split(" ")[1];null==d?
...
192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,255],navy:[0,0,128],white:[255,255,255],fuchsia:[255,0,255],olive:[128,128,0],yellow:[255,255,0],orange:[255,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[255,0,0],pink:[255,192,203],cyan:[0,255,255],transparent:[255,255,255,0]};N&&(n=m.createElement("style"),n.styleSheet&&m.getElementsByTagName("head")[0].appendChild(n));i._onInitTween=function(b,c,d){if(!b.nodeType)return!1;this._target=b;this._tween=d;this._classData=
this._transform=null;P=c.autoRound;var v=this._style=b.style,p=z(b,""),f,h;if(M&&""===v.zIndex&&(h=E(b,"zIndex",p),"auto"===h||""===h))v.zIndex=0;"string"===typeof c?(f=v.cssText,d=g(b,p),v.cssText=f+";"+c,h=u(d,g(b)),!C&&e.test(c)&&(h.opacity=parseFloat(RegExp.$1)),c=h,v.cssText=f):c.className&&(f=b.className,this._classData={b:f,e:"="!==c.className.charAt(1)?c.className:"+"===c.className.charAt(0)?b.className+" "+c.className.substr(2):b.className.split(c.className.substr(2)).join(""),props:[]},
d._duration?(d=g(b,p),b.className=this._classData.e,c=u(d,g(b),c,this._classData),b.className=f):c={});this._parseVars(c,b,p,c.suffixMap||w.suffixMap);return!0};i._parseVars=function(b,g,c,d){var u=this._style,p,f,e,h,k,i,n;for(p in b)if(f=b[p],"transform"===p||p===J)this._parseTransform(g,f,c,d);else if(v[p]||"transformOrigin"===p)this._parseTransform(g,b,c,d);else{if("alpha"===p||"autoAlpha"===p)p="opacity";else if("margin"===p||"padding"===p){f=(f+"").split(" ");k=f.length;e={};e[p+"Top"]=f[0];
e[p+"Right"]=1<k?f[1]:f[0];e[p+"Bottom"]=4===k?f[2]:f[0];e[p+"Left"]=4===k?f[3]:2===k?f[1]:f[0];this._parseVars(e,g,c,d);continue}else if("backgroundPosition"===p||"backgroundSize"===p){e=V(f);n=V(h=E(g,p,c));this._firstPT=e={_next:this._firstPT,t:u,p:p,b:h,f:!1,n:"css_"+p,type:3,s:n.ox,c:e.oxr?e.ox:e.ox-n.ox,ys:n.oy,yc:e.oyr?e.oy:e.oy-n.oy,sfx:e.oxp?"%":"px",ysfx:e.oyp?"%":"px",r:!e.oxp&&!1!==b.autoRound};e.e=e.s+e.c+e.sfx+" "+(e.ys+e.yc)+e.ysfx;continue}else if("border"===p){f=(f+"").split(" ");
this._parseVars({borderWidth:f[0],borderStyle:f[1]||"none",borderColor:f[2]||"#000000"},g,c,d);continue}else if("bezier"===p){this._parseBezier(f,g,c,d);continue}else if("autoRound"===p)continue;h=E(g,p,c);h=null!=h?h+"":"";this._firstPT=e={_next:this._firstPT,t:u,p:p,b:h,f:!1,n:"css_"+p,sfx:"",r:!1,type:0};"opacity"===p&&null!=b.autoAlpha&&("1"===h&&"hidden"===E(g,"visibility",c)&&(h=e.b="0"),this._firstPT=e._prev={_next:e,t:u,p:"visibility",f:!1,n:"css_visibility",r:!1,type:-1,b:0!==Number(h)?"visible":
"hidden",i:"visible",e:0===Number(f)?"hidden":"visible"},this._overwriteProps.push("css_visibility"));k="string"===typeof f;if("color"===p||"fill"===p||"stroke"===p||-1!==p.indexOf("Color")||k&&!f.indexOf("rgb(")){if(k=H(h),f=H(f),e.e=e.i=(3<f.length?"rgba(":"rgb(")+f.join(",")+")",e.b=(3<k.length?"rgba(":"rgb(")+k.join(",")+")",e.s=Number(k[0]),e.c=Number(f[0])-e.s,e.gs=Number(k[1]),e.gc=Number(f[1])-e.gs,e.bs=Number(k[2]),e.bc=Number(f[2])-e.bs,e.type=1,3<k.length||3<f.length)C?(e.as=4>k.length?
1:Number(k[3]),e.ac=(4>f.length?1:Number(f[3]))-e.as,e.type=2):(0==f[3]&&(e.e=e.i="transparent",e.type=-1),0==k[3]&&(e.b="transparent"))}else{i=h.replace(s,"");if(""===h||"auto"===h)if("width"===p||"height"===p){var I=p;i=g;n=c;h=parseFloat("width"===I?i.offsetWidth:i.offsetHeight);var I=X[I],m=I.length;for(n=n||z(i,null);-1<--m;)h-=parseFloat(E(i,"padding"+I[m],n,!0))||0,h-=parseFloat(E(i,"border"+I[m]+"Width",n,!0))||0;n=h;i="px"}else n="opacity"!==p?0:1,i="";else n=-1===h.indexOf(" ")?parseFloat(h.replace(q,
"")):NaN;k?(k="="===f.charAt(1),h=f.replace(s,""),f=-1===f.indexOf(" ")?parseFloat(f.replace(q,"")):NaN):(k=!1,h="");""===h&&(h=d[p]||i);e.e=f||0===f?(k?f+n:f)+h:b[p];if(i!==h&&""!==h&&(f||0===f))if(n||0===n)if(n=Q(g,p,n,i),"%"===h?(n/=Q(g,p,100,"%")/100,100<n&&(n=100)):"em"===h?n/=Q(g,p,1,"em"):(f=Q(g,p,f,h),h="px"),k&&(f||0===f))e.e=f+n+h;if((n||0===n)&&(f||0===f)&&(e.c=k?f:f-n))if(e.s=n,e.sfx=h,"opacity"===p)C||(e.type=4,e.p="filter",e.b="alpha(opacity="+100*e.s+")",e.e="alpha(opacity="+100*(e.s+
e.c)+")",e.dup=null!=b.autoAlpha,this._style.zoom=1);else{if(!1!==P&&("px"===h||"zIndex"===p))e.r=!0}else e.type=-1,e.i="display"===p&&"none"===e.e?e.b:e.e,e.s=e.c=0}this._overwriteProps.push("css_"+p);e._next&&(e._next._prev=e)}};i._parseTransform=function(b,g,c){if(!this._transform){var d=this._transform=S(b,c,!0),p=this._style,e,f,u;if("object"===typeof g){e={scaleX:T(null!=g.scaleX?g.scaleX:g.scale,d.scaleX),scaleY:T(null!=g.scaleY?g.scaleY:g.scale,d.scaleY),x:T(g.x,d.x),y:T(g.y,d.y)};null!=g.shortRotation?
(e.rotation="number"===typeof g.shortRotation?g.shortRotation*L:U(g.shortRotation,d.rotation),f=(e.rotation-d.rotation)%(2*Math.PI),f!==f%Math.PI&&(f+=Math.PI*(0>f?2:-2)),e.rotation=d.rotation+f):e.rotation=null==g.rotation?d.rotation:"number"===typeof g.rotation?g.rotation*L:U(g.rotation,d.rotation);e.skewX=null==g.skewX?d.skewX:"number"===typeof g.skewX?g.skewX*L:U(g.skewX,d.skewX);e.skewY=null==g.skewY?d.skewY:"number"===typeof g.skewY?g.skewY*L:U(g.skewY,d.skewY);if(f=e.skewY-d.skewY)e.skewX+=
f,e.rotation+=f;1E-6>e.skewY&&-1E-6<e.skewY&&(e.skewY=0);1E-6>e.skewX&&-1E-6<e.skewX&&(e.skewX=0);1E-6>e.rotation&&-1E-6<e.rotation&&(e.rotation=0);if(null!=(g=g.transformOrigin))J?(u=J+"Origin",this._firstPT=g={_next:this._firstPT,t:p,p:u,s:0,c:0,n:u,f:!1,r:!1,b:p[u],e:g,i:g,type:-1,sfx:""},g._next&&(g._next._prev=g)):V(g,d)}else if("string"===typeof g&&J)f=p[J],p[J]=g,e=S(b,null,!1),p[J]=f;else return;if(J){if(N&&(M=!0,""===p.WebkitBackfaceVisibility&&(p.WebkitBackfaceVisibility="hidden"),""===
p.zIndex&&(f=E(b,"zIndex",c),"auto"===f||""===f)))p.zIndex=0}else p.zoom=1;for(u in v)if((d[u]!==e[u]||null!=x[u])&&"shortRotation"!==u&&"scale"!==u)this._firstPT=g={_next:this._firstPT,t:d,p:u,s:d[u],c:e[u]-d[u],n:u,f:!1,r:!1,b:d[u],e:e[u],type:0,sfx:0},g._next&&(g._next._prev=g),this._overwriteProps.push("css_"+u)}};i._parseBezier=function(b,g,c,d){if(window.com.greensock.plugins.BezierPlugin){b instanceof Array&&(b={values:b});var p=b.values||[],v=p.length,e=[],f=this._bezier={_pt:[]},u=f._proxy=
{},h=0,k=0,i={},n=v-1,q=x,s=f._plugin=new window.com.greensock.plugins.BezierPlugin,I,m,K,t,w;for(I=0;I<v;I++){t={};this._transform=null;K=this._firstPT;this._parseVars(x=p[I],g,c,d);m=this._firstPT;if(0===I){for(w=this._transform;m!==K;)u[m.p]=m.s,f._pt[k++]=i[m.p]=m,1===m.type||2===m.type?(u[m.p+"_g"]=m.gs,u[m.p+"_b"]=m.bs,2===m.type&&(u[m.p+"_a"]=m.as)):3===m.type&&(u[m.p+"_y"]=m.ys),m=m._next;m=this._firstPT}else this._firstPT=K,K._prev&&(K._prev._next=null),K=K._prev=null;for(;m!==K;)i[m.p]&&
(t[m.p]=m.s+m.c,I===n&&(i[m.p].e=m.e),1===m.type||2===m.type?(t[m.p+"_g"]=m.gs+m.gc,t[m.p+"_b"]=m.bs+m.bc,2===m.type&&(t[m.p+"_a"]=m.as+m.ac)):3===m.type&&(t[m.p+"_y"]=m.ys+m.yc),0===I&&(m.c=m.ac=m.gc=m.bc=m.yc=0)),m=m._next;e[h++]=t}this._transform=w;x=q;b.values=e;0===b.autoRotate&&(b.autoRotate=!0);b.autoRotate&&!(b.autoRotate instanceof Array)&&(I=!0==b.autoRotate?0:Number(b.autoRotate)*Math.PI/180,b.autoRotate=null!=e[0].left?[["left","top","rotation",I,!0]]:null!=e[0].x?[["x","y","rotation",
I,!0]]:!1);if((f._autoRotate=b.autoRotate)&&!w)this._transform=S(g,c,!0);s._onInitTween(u,b,this._tween);b.values=p}else console.log("Error: BezierPlugin not loaded.")};i.setRatio=function(b){var g=this._firstPT,c=this._bezier,d=1E-6,p,v;if(c){c._plugin.setRatio(b);var e=c._pt,f=c._proxy;for(v=e.length;-1<--v;)g=e[v],g.s=f[g.p],1===g.type||2===g.type?(g.gs=f[g.p+"_g"],g.bs=f[g.p+"_b"],2===g.type&&(g.as=f[g.p+"_a"])):3===g.type&&(g.ys=f[g.p+"_y"]);c._autoRotate&&(this._transform.rotation=f.rotation)}if(1===
b&&(this._tween._time===this._tween._duration||0===this._tween._time))for(;g;)g.t[g.p]=g.e,4===g.type&&1===g.s+g.c&&(this._style.removeAttribute("filter"),E(this._target,"filter")&&(g.t[g.p]=g.e)),g=g._next;else if(b||!(this._tween._time===this._tween._duration||0===this._tween._time))for(;g;)p=g.c*b+g.s,g.r?p=0<p?p+0.5>>0:p-0.5>>0:p<d&&p>-d&&(p=0),g.type?1===g.type?g.t[g.p]="rgb("+(p>>0)+", "+(g.gs+b*g.gc>>0)+", "+(g.bs+b*g.bc>>0)+")":2===g.type?g.t[g.p]="rgba("+(p>>0)+", "+(g.gs+b*g.gc>>0)+", "+
(g.bs+b*g.bc>>0)+", "+(g.as+b*g.ac)+")":-1===g.type?g.t[g.p]=g.i:3===g.type?(c=g.ys+b*g.yc,g.r&&(c=0<c?c+0.5>>0:c-0.5>>0),g.t[g.p]=p+g.sfx+" "+c+g.ysfx):(g.dup&&(g.t.filter=g.t.filter||"alpha(opacity=100)"),g.t.filter=-1===g.t.filter.indexOf("opacity")?g.t.filter+(" alpha(opacity="+(100*p>>0)+")"):g.t.filter.replace(t,"opacity="+(100*p>>0))):g.t[g.p]=p+g.sfx,g=g._next;else for(;g;)g.t[g.p]=g.b,4===g.type&&1===g.s&&(this._style.removeAttribute("filter"),E(this._target,"filter")&&(g.t[g.p]=g.b)),g=
g._next;if(this._transform)if(g=this._transform,J&&!g.rotation&&!g.skewX)this._style[J]=(g.x||g.y?"translate("+g.x+"px,"+g.y+"px) ":"")+(1!==g.scaleX||1!==g.scaleY?"scale("+g.scaleX+","+g.scaleY+")":"")||"translate(0px,0px)";else{var e=J?g.rotation:-g.rotation,u=J?e-g.skewX:e+g.skewX,c=Math.cos(e)*g.scaleX,e=Math.sin(e)*g.scaleX,f=Math.sin(u)*-g.scaleY,u=Math.cos(u)*g.scaleY,h;c<d&&c>-d&&(c=0);e<d&&e>-d&&(e=0);f<d&&f>-d&&(f=0);u<d&&u>-d&&(u=0);if(J)this._style[J]="matrix("+c+","+e+","+f+","+u+","+
g.x+","+g.y+")";else if(h=this._target.currentStyle){d=e;e=-f;f=-d;d=h.filter;this._style.filter="";v=this._target.offsetWidth;p=this._target.offsetHeight;var k="absolute"!==h.position,i="progid:DXImageTransform.Microsoft.Matrix(M11="+c+", M12="+e+", M21="+f+", M22="+u,m=g.x,n=g.y,q,I;null!=g.ox&&(q=(g.oxp?0.01*v*g.ox:g.ox)-v/2,I=(g.oyp?0.01*p*g.oy:g.oy)-p/2,m=q-(q*c+I*e)+g.x,n=I-(q*f+I*u)+g.y);if(k)q=v/2,I=p/2,i+=", Dx="+(q-(q*c+I*e)+m)+", Dy="+(I-(q*f+I*u)+n)+")";else{var K=8>F?1:-1;q=g.ieOffsetX||
0;I=g.ieOffsetY||0;g.ieOffsetX=Math.round((v-((0>c?-c:c)*v+(0>e?-e:e)*p))/2+m);g.ieOffsetY=Math.round((p-((0>u?-u:u)*p+(0>f?-f:f)*v))/2+n);for(v=0;4>v;v++)m=Y[v],p=h[m],p=-1!==p.indexOf("px")?parseFloat(p):Q(this._target,m,parseFloat(p),p.replace(s,""))||0,n=p!==g[m]?2>v?-g.ieOffsetX:-g.ieOffsetY:2>v?q-g.ieOffsetX:I-g.ieOffsetY,this._style[m]=(g[m]=Math.round(p-n*(0===v||2===v?1:K)))+"px";i+=", sizingMethod='auto expand')"}this._style.filter=-1!==d.indexOf("DXImageTransform.Microsoft.Matrix(")?d.replace(A,
i):i+" "+d;if(0===b||1===b)if(1===c&&0===e&&0===f&&1===u&&(!k||-1!==i.indexOf("Dx=0, Dy=0")))(!t.test(d)||100===parseFloat(RegExp.$1))&&this._style.removeAttribute("filter")}}if(this._classData)if(g=this._classData,1===b&&(this._tween._time===this._tween._duration||0===this._tween._time)){for(v=g.props.length;-1<--v;)this._style[g.props[v]]="";this._target.className=g.e}else this._target.className!==g.b&&(this._target.className=g.b)};i._kill=function(g){var b=g,c;if(g.autoAlpha||g.alpha){b={};for(c in g)b[c]=
g[c];b.opacity=1;b.autoAlpha&&(b.visibility=1)}return y.prototype._kill.call(this,b)};y.activate([w]);return w},!0);_gsDefine("plugins.RoundPropsPlugin",["plugins.TweenPlugin"],function(y){var w=function(){y.call(this,"roundProps",-1);this._overwriteProps.length=0},i=w.prototype=new y("roundProps",-1);i.constructor=w;w.API=2;i._onInitTween=function(i,s,c){this._tween=c;return!0};i._onInitAllProps=function(){for(var i=this._tween,s=i.vars.roundProps instanceof Array?i.vars.roundProps:i.vars.roundProps.split(","),
c=s.length,t={},e=i._propLookup.roundProps,b,h,d;-1<--c;)t[s[c]]=1;for(c=s.length;-1<--c;){b=s[c];for(h=i._firstPT;h;)d=h._next,h.pg?h.t._roundProps(t,!0):h.n===b&&(this._add(h.t,b,h.s,h.c),d&&(d._prev=h._prev),h._prev?h._prev._next=d:_tween._firstPT===h&&(i._firstPT=d),h._next=h._prev=null,i._propLookup[b]=e),h=d}return!1};i._add=function(i,s,c,t){this._addTween(i,s,c,c+t,s,!0);this._overwriteProps.push(s)};y.activate([w]);return w},!0);_gsDefine("easing.Back",["easing.Ease"],function(y){var w=window.com.greensock._class,
i=function(b,c){var d=w("easing."+b,function(){},!0),e=d.prototype=new y;e.constructor=d;e.getRatio=c;return d},q=function(b,c){var d=w("easing."+b,function(b){this._p1=b||0===b?b:1.70158;this._p2=1.525*this._p1},!0),e=d.prototype=new y;e.constructor=d;e.getRatio=c;e.config=function(b){return new d(b)};return d},s=q("BackOut",function(b){return(b-=1)*b*((this._p1+1)*b+this._p1)+1}),c=q("BackIn",function(b){return b*b*((this._p1+1)*b-this._p1)}),q=q("BackInOut",function(b){return 1>(b*=2)?0.5*b*b*
((this._p2+1)*b-this._p2):0.5*((b-=2)*b*((this._p2+1)*b+this._p2)+2)}),t=i("BounceOut",function(b){return b<1/2.75?7.5625*b*b:b<2/2.75?7.5625*(b-=1.5/2.75)*b+0.75:b<2.5/2.75?7.5625*(b-=2.25/2.75)*b+0.9375:7.5625*(b-=2.625/2.75)*b+0.984375}),e=i("BounceIn",function(b){return(b=1-b)<1/2.75?1-7.5625*b*b:b<2/2.75?1-(7.5625*(b-=1.5/2.75)*b+0.75):b<2.5/2.75?1-(7.5625*(b-=2.25/2.75)*b+0.9375):1-(7.5625*(b-=2.625/2.75)*b+0.984375)}),b=i("BounceInOut",function(b){var c=0.5>b,b=c?1-2*b:2*b-1,b=b<1/2.75?7.5625*
b*b:b<2/2.75?7.5625*(b-=1.5/2.75)*b+0.75:b<2.5/2.75?7.5625*(b-=2.25/2.75)*b+0.9375:7.5625*(b-=2.625/2.75)*b+0.984375;return c?0.5*(1-b):0.5*b+0.5}),h=i("CircOut",function(b){return Math.sqrt(1-(b-=1)*b)}),d=i("CircIn",function(b){return-(Math.sqrt(1-b*b)-1)}),f=i("CircInOut",function(b){return 1>(b*=2)?-0.5*(Math.sqrt(1-b*b)-1):0.5*(Math.sqrt(1-(b-=2)*b)+1)}),k=2*Math.PI,A=function(b,c,d){var e=w("easing."+b,function(b,c){this._p1=b||1;this._p2=c||d;this._p3=this._p2/k*(Math.asin(1/this._p1)||0)},
!0),b=e.prototype=new y;b.constructor=e;b.getRatio=c;b.config=function(b,c){return new e(b,c)};return e},L=A("ElasticOut",function(b){return this._p1*Math.pow(2,-10*b)*Math.sin((b-this._p3)*k/this._p2)+1},0.3),O=A("ElasticIn",function(b){return-(this._p1*Math.pow(2,10*(b-=1))*Math.sin((b-this._p3)*k/this._p2))},0.3),A=A("ElasticInOut",function(b){return 1>(b*=2)?-0.5*this._p1*Math.pow(2,10*(b-=1))*Math.sin((b-this._p3)*k/this._p2):0.5*this._p1*Math.pow(2,-10*(b-=1))*Math.sin((b-this._p3)*k/this._p2)+
1},0.45),x=i("ExpoOut",function(b){return 1-Math.pow(2,-10*b)}),m=i("ExpoIn",function(b){return Math.pow(2,10*(b-1))-0.001}),B=i("ExpoInOut",function(b){return 1>(b*=2)?0.5*Math.pow(2,10*(b-1)):0.5*(2-Math.pow(2,-10*(b-1)))}),n=Math.PI/2,P=i("SineOut",function(b){return Math.sin(b*n)}),M=i("SineIn",function(b){return-Math.cos(b*n)+1}),i=i("SineInOut",function(b){return-0.5*(Math.cos(Math.PI*b)-1)}),N=w("easing.SlowMo",function(b,c,d){null==b?b=0.7:1<b&&(b=1);this._p=1!=b?c||0===c?c:0.7:0;this._p1=
(1-b)/2;this._p2=b;this._p3=this._p1+this._p2;this._calcEnd=!0===d},!0),F=N.prototype=new y;F.constructor=N;F.getRatio=function(b){var c=b+(0.5-b)*this._p;return b<this._p1?this._calcEnd?1-(b=1-b/this._p1)*b:c-(b=1-b/this._p1)*b*b*b*c:b>this._p3?this._calcEnd?1-(b=(b-this._p3)/this._p1)*b:c+(b-c)*(b=(b-this._p3)/this._p1)*b*b*b:this._calcEnd?1:c};N.ease=new N(0.7,0.7);F.config=N.config=function(b,c,d){return new N(b,c,d)};var C=w("easing.SteppedEase",function(b){b=b||1;this._p1=1/b;this._p2=b+1},
!0),F=C.prototype=new y;F.constructor=C;F.getRatio=function(b){0>b?b=0:1<=b&&(b=0.999999999);return(this._p2*b>>0)*this._p1};F.config=C.config=function(b){return new C(b)};w("easing.Bounce",{easeOut:new t,easeIn:new e,easeInOut:new b},!0);w("easing.Circ",{easeOut:new h,easeIn:new d,easeInOut:new f},!0);w("easing.Elastic",{easeOut:new L,easeIn:new O,easeInOut:new A},!0);w("easing.Expo",{easeOut:new x,easeIn:new m,easeInOut:new B},!0);w("easing.Sine",{easeOut:new P,easeIn:new M,easeInOut:new i},!0);
return{easeOut:new s,easeIn:new c,easeInOut:new q}},!0)});
...
b;d;){e=d._next;if(d._active||b>=d._startTime&&!d._paused)d._reversed?d.render((!d._dirty?d._totalDuration:d.totalDuration())-(b-d._startTime)*d._timeScale,c,!1):d.render((b-d._startTime)*d._timeScale,c,!1);d=e}};c.rawTime=function(){return this._totalTime};var n=d("TweenLite",function(b,c,d){m.call(this,c,d);if(null==b)throw"Cannot tween an undefined reference.";this.target=b;this._overwrite=null==this.vars.overwrite?C[n.defaultOverwrite]:"number"===typeof this.vars.overwrite?this.vars.overwrite>>
...
G(b,this,null,1,this._siblings);(this.vars.immediateRender||0===c&&0===this._delay&&!1!=this.vars.immediateRender)&&this.render(-this._delay,!1,!0)},!0);c=n.prototype=new m;c.constructor=n;c.kill()._gc=!1;c.ratio=0;c._firstPT=c._targets=c._overwrittenProps=null;c._notifyPluginsOfEnabled=!1;n.version=12;n.defaultEase=c._ease=new A(null,null,1,1);n.defaultOverwrite="auto";n.ticker=B;var P=n._plugins={},M=n._tweenLookup={},N=0,F={ease:1,delay:1,overwrite:1,onComplete:1,onCompleteParams:1,onCompleteScope:1,
useFrames:1,runBackwards:1,startAt:1,onUpdate:1,onUpdateParams:1,onUpdateScope:1,onStart:1,onStartParams:1,onStartScope:1,onReverseComplete:1,onReverseCompleteParams:1,onReverseCompleteScope:1,onRepeat:1,onRepeatParams:1,onRepeatScope:1,easeParams:1,yoyo:1,orientToBezier:1,immediateRender:1,repeat:1,repeatDelay:1,data:1,paused:1,reversed:1},C={none:0,all:1,auto:2,concurrent:3,allOnStart:4,preexisting:5,"true":1,"false":0},p=m._rootFramesTimeline=new i,D=m._rootTimeline=new i;D._startTime=B.time;p._startTime=
B.frame;D._active=p._active=!0;m._updateRoot=function(){D.render((B.time-D._startTime)*D._timeScale,!1,!1);p.render((B.frame-p._startTime)*p._timeScale,!1,!1);if(!(B.frame%120)){var b,c,d;for(d in M){c=M[d].tweens;for(b=c.length;-1<--b;)c[b]._gc&&c.splice(b,1);0===c.length&&delete M[d]}}};B.addEventListener("tick",m._updateRoot);var H=function(b,c,d){var e=b._gsTweenID,f;if(!M[e||(b._gsTweenID=e="t"+N++)])M[e]={target:b,tweens:[]};if(c&&(b=M[e].tweens,b[f=b.length]=c,d))for(;-1<--f;)b[f]===c&&b.splice(f,
...
this.vars.ease instanceof A?this.vars.easeParams instanceof Array?this.vars.ease.config.apply(this.vars.ease,this.vars.easeParams):this.vars.ease:"function"===typeof this.vars.ease?new A(this.vars.ease,this.vars.easeParams):n.defaultEase;this._easeType=this._ease._type;this._easePower=this._ease._power;this._firstPT=null;if(this._targets)for(b=this._targets.length;-1<--b;){if(this._initProps(this._targets[b],this._propLookup[b]={},this._siblings[b],this._overwrittenProps?this._overwrittenProps[b]:
null))c=!0}else c=this._initProps(this.target,this._propLookup,this._siblings,this._overwrittenProps);c&&n._onPluginEvent("_onInitAllProps",this);this._overwrittenProps&&null==this._firstPT&&"function"!==typeof this.target&&this._enabled(!1,!1);if(this.vars.runBackwards)for(b=this._firstPT;b;)b.s+=b.c,b.c=-b.c,b=b._next;this._onUpdate=this.vars.onUpdate;this._initted=!0};c._initProps=function(b,c,d,e){var f,h,k,i,m,n;if(null==b)return!1;for(f in this.vars){if(F[f]){if("onStartParams"===f||"onUpdateParams"===
...
--c;)d[c]._gc&&d.splice(c,1)}return d}};var E=d("plugins.TweenPlugin",function(b,c){this._overwriteProps=(b||"").split(",");this._propName=this._overwriteProps[0];this._priority=c||0},!0);c=E.prototype;E.version=12;E.API=2;c._firstPT=null;c._addTween=function(b,c,d,e,f,h){var i;if(null!=e&&(i="number"===typeof e||"="!==e.charAt(1)?Number(e)-d:Number(e.split("=").join(""))))this._firstPT={_next:this._firstPT,t:b,p:c,s:d,c:i,f:"function"===typeof b[c],n:f||c,r:h},this._firstPT._next&&(this._firstPT._next._prev=
...
c=c._next;return!1};c._roundProps=function(b,c){for(var d=this._firstPT;d;){if(b[this._propName]||null!=d.n&&b[d.n.split(this._propName+"_").join("")])d.r=c;d=d._next}};n._onPluginEvent=function(b,c){var d=c._firstPT,e;if("_onInitAllProps"===b){for(var f,h,i,k;d;){k=d._next;for(f=h;f&&f.pr>d.pr;)f=f._next;(d._prev=f?f._prev:i)?d._prev._next=d:h=d;(d._next=f)?f._prev=d:i=d;d=k}d=c._firstPT=h}for(;d;)d.pg&&"function"===typeof d.t[b]&&d.t[b]()&&(e=!0),d=d._next;return e};E.activate=function(b){for(var c=
b.length;-1<--c;)b[c].API===E.API&&(n._plugins[(new b[c])._propName]=b[c]);return!0};if(q=y._gsQueue){for(s=0;s<q.length;s++)q[s]();for(c in b)b[c].def||console.log("Warning: TweenLite encountered missing dependency: com.greensock."+c)}})(window);
